...
\patchcmd{\ps@customFooterStyle}{\thepage}{
    \color{gray}\textit{\small Nicholas Judge - Page \thepage{} of \pageref*{LastPage}}
...
\begin{onecolentry}
    \textbf{Languages:} Rust, C\#, C++, C, Java, JavaScript, SQL, HTML/CSS, Bash
\end{onecolentry}
\vspace{0.2 cm}
\begin{onecolentry}
    \textbf{Technologies:} .NET, Microsoft SQL Server, Git, Linux, Kubernetes, Docker, Reach, Node, AWS
\end{onecolentry}
\section{Experience}
\begin{twocolentry}{
    \textit{Baltimore, MD}
...
\begin{onecolentry}
    ...
    \section{Projects}
    \begin{twocolentry}{
        \textit{\href{https://github.com/sirjudge/data-comparison-tool}{github.com/sirjudge/repo}}}
        \textbf{Data Comparison Tool}
    \end{twocolentry}
    \begin{onecolentry}
        \begin{highlights}
        \item Rust CLI tool used to compare two input data sets from MYSQL and creates a local sqlite database used to compare the added, changed, or removed rows between the two data sets.
        \end{highlights}
    \end{onecolentry}
    \begin{twocolentry}{
        \textit{\href{https://github.com/sirjudge/dotfiles}{https://github.com/sirjudge/dotfiles}}}
        \textbf{Nix Configuration}
    \end{twocolentry}
    \begin{onecolentry}
        \begin{highlights}
        \item Nix configuration used to manage personal developemnt environment and dotfiles
        \end{highlights}
    \end{onecolentry}
    \end{document}
