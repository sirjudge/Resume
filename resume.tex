...
\begin{onecolentry}
    \begin{highlights}
        ...
        \item Developed fraud detection REST API and MSSQL table schemas with React frontend integration, tracking malicious activities across multiple platform services
...
\end{onecolentry}
    ...
    \begin{onecolentry}
        \begin{highlights}
        \item Internal presentation detailing the journey of building and deploying Rust code in production environments
        \end{highlights}
    \end{onecolentry}
    \begin{twocolentry}{
